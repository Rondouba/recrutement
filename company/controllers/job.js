...
// obtenir toutes les applications avec les travaux lorsque getApplication=true est passé dans la requête
...
const getJobsList = async (req, res) => {
  try {
    const whereOpts = [];
    const {
      city, state, q, companyId, location, all, type, industry, since,
    } = req.query;
