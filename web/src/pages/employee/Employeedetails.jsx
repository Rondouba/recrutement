...
const Employeedetails = () => {
  ...
  const saveDetails = async (e) => {
    ...
    if (companyName === '') {
      ...
      if (companyID === null) {
        toast.error('Veuillez sélectionner une entreprise valide ou laisser vide pour créer une nouvelle entreprise!');
        return;
      }
      const body = {
        id: user.user.id,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Vous n'avez jamais publié d'offre d'emploi auparavant, vous devrez donc
                créer un compte employeur.
              </span>
            </div>
            <div
            ...
            >
              ...
              <div className="employeeform">
                <label className="employeeLabel">
                  Votre rôle dans le processus d'embauche
                </label>
                <CustomAutocomplete
                  className="employeeInput"
                  sx={{
              ...
              <div className="employeeform">
                <label className="employeeLabel">Votre addresse</label>
                <input
                  type="text"
                  value={address}
              ...
              <div className="employeeform">
                <label className="employeeLabel">
                  Sélectionnez l'entreprise ou laissez vide si vous créez une nouvelle entreprise
                </label>
                <CustomAutocomplete
                  className="employeeInput"
                  sx={{
