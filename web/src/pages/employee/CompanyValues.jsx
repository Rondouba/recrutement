        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Votre est nouvellement crée, parlez-nous d'elle...
              </span>
            </div>
            <div
              style={{
          ...
          >
            ...
            >
              ...
              <span style={{ paddingTop: '0.5rem', color: 'rgb(89, 89, 89)', fontSize: '14px' }}>Donnez un aperçu du travail dans votre entreprise en ajoutant des photos à votre message</span>
              <div>
                <input
              ...
              <span className="employeeLabel">Ajouter le Logo</span>
              <div>
                <input
                  onChange={uploadLogo}
                  type="file"
          ...
          >
            <div>
              <button className="employeeBack" onClick={backtoprofile}>Retour</button>
            </div>
            <div>
