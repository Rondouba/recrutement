      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="employeeform">
              <label className="employeeLabel">Domaine</label>
              <select
                className="employeeInput"
                // select
                value={industry}
            ...
            <div className="employeeform">
              <label className="employeeLabel">Addresse</label>
              <input
                type="text"
                value={address}
            ...
            <div className="employeeform">
              <label className="employeeLabel">Ville</label>
              <input
                type="text"
                value={city}
            ...
            <div className="employeeform">
              <label className="employeeLabel">Pays</label>
              <CountryDropdown
                value={country}
            ...
            <div className="employeeform">
              <label className="employeeLabel">Région</label>
              <RegionDropdown
                country={country}
                value={region}
            ...
            <div className="employeeform">
              <label className="employeeLabel">
                Questions aux candidats (séparées par des virgules)
                <span style={{ paddingLeft: '5px', color: 'red' }}>*</span>
              </label>
              <input
                type="text"
