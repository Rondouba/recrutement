  ...
  return (
    <>
      ...
      >
        ...
        >
          Votre salaire anonyme aidera d'autres demandeurs d'emploi.
        </Typography>
      </div>
      ...
      <div>
        <form onSubmit={handleSubmit}>
          <div style={{ display: 'flex' }}>
            <div>
              <p style={{ fontWeight: 'bold', color: 'rgb(45, 45, 45)' }}>
                Quel est votre salaire chez XYZ?
                {' '}
            ...
            >
              <FormControl variant="standard">
                <Select
                  ...
                  value="per year"
                >
                  <MenuItem value="per year">Pra année</MenuItem>
                </Select>
              </FormControl>
            </div>
          </div>
          ...
          <p style={{ fontWeight: 'bold', color: 'rgb(45, 45, 45)' }}>
            Combien d'années d'expérience pertinente avez-vous?
            {' '}
            <span style={{ color: '#db183f' }}>*</span>
          </p>
          <TextField
          ...
          <p style={{ fontWeight: 'bold', color: 'rgb(45, 45, 45)' }}>
            De quelles prestations avez-vous bénéficié chez xyz?
            {' '}
            <span style={{ color: '#db183f' }}>*</span>
          </p>
          <div
