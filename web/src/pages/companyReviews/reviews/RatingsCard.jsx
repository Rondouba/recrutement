    ...
    <>
      <div style={{ display: 'flex', marginTop: '20px', width: '900px' }}>
        ...
        >
          ...
          >
            {props.review.helpful ? `${props.review.helpful} les gens l'ont trouvé utile` : ''}
          </span>
          {props.showButtons ? (
            <span
              style={{
            ...
            >
              {!props.flag ? 'Avis en vedette?' : 'Cet avis est-il utile?'}
            </span>
          ) : null}
          {props.showButtons ? (
              ...
              {props && props.flag === false ? (
                <Switch
                  ...
                  onClick={async () => {
                    ...
                    toast.success('État de la fonctionnalité mis à jour!');
                  }}
                />
              ) : (
                <div>
