          ...
          <Grid sx={{ flexGrow: 1 }} container spacing={2}>
            <Grid item xs={12}>
              <Grid container justifyContent="center" spacing={2}>
                <Grid item>
                  <CompanyInfoCard title="PDG" subtitle={(props.data && props.data.ceo) ? props.data.ceo : 'Non reporté'} />
                </Grid>
                <Grid item>
                  <CompanyInfoCard title="Fondateur" subtitle={(props.data && props.data.foundedOn) ? new Date(props.data.foundedOn).getFullYear() : 'ANNE'} />
                </Grid>
                <Grid item>
                  <CompanyInfoCard title="Taille de l'entreprise" subtitle={(props.data && props.data.size) ? props.data.size.toLocaleString() : 'NA'} />
                </Grid>
                <Grid item>
