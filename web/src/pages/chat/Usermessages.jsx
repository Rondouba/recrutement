...
function Usermessages({ openChat }) {
  ...
  const messageSend = async () => {
    if (!message.length) {
      toast.error('Message ne peut pas être vide!');
      return;
    }
    if (!openChat.employer) {
      toast.error('Veuillez selectionner le destinataire du message!');
      return;
    }
    const payload = {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  >
                    {option.to === chatInfo.user._id ? (
                      ...
                      <img width="45px" src={UserIcon} alt="Entreprise" />
                    )}
                  </div>
                  <div
                    style={{
        ...
        >
          <TextField
            ...
            placeholder="Ecrivez votre messages"
            style={{ border: 'none' }}
          />
          <Button
            label="Envoyer"
