...
const getCompanyConnection = () => {
  ...
  const CompanySchema = new mongoose.Schema({
    ...
    about: String,//apropos
    workCulture: String,//culture generale
    values: String,//valeur
    foundedOn: Date,//fondée
    mission: String,
    ceo: String,
    industry: IndustrySchema,//domaine
    headquarters: String,//quartier general
    revenue: String,
    size: Number,//taille
    website: String,
    type: String,
    avgHappinessScore: Number,//Score de bonheur moyen
